			...
			<b-row> 
				...
				>
					...
					<b-button
						...
						v-bind:aria-label="$t('shared.label-copy')"
					...
					<b-button
						...
						v-bind:aria-label="$t('shared.label-paste')"
					...
					<b-button
						...
						v-bind:aria-label="!items[index].active ? $t('shared.label-enable') : $t('shared.label-disable')"
					...
					<b-button
						...
						v-bind:aria-label="$t('shared.label-delete')"
	...
	>
		...
		>
			...
			<b-button
				...
				v-bind:aria-label="$t('shared.label-add')"
