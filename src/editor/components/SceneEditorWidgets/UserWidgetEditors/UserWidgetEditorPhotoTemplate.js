    ...
    <section>
        <b-form>
            ...
            <b-col>
                    ...
                    <b-form-select v-bind:options="typeOfCapture" v-model="typedValue.type"></b-form-select>
                
                
                     <b-form-radio v-model="typedValue.cap" value="user">User</b-form-radio>
                     <b-form-radio v-model="typedValue.cap" value="enviroment"">Enviroment</b-form-radio>
