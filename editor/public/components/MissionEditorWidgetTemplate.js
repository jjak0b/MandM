...
`<div class="row" >
	<div class="col-3">
		...
		<ul id="mission-list" class="list-group overflow-auto" tabindex="0" role="listbox">
			<li
				v-for="(mission, index) in missions"
				v-on:click="load( mission )"
				v-bind:class="['list-group-item', 'list-group-item-action', value == mission ? 'active' : '' ]"
				role="option"
				v-bind:aria-selected="value == mission"
				>
				<i18n-input-widget
					v-bind:tag="'label'"
	...
	<form autocomplete="off" class="col-9" v-on:submit.prevent="save()" >
